...
<div class="row block-margin-bottom">
    <div class="col-md-12">
        <button class="btn btn-default" data-toggle="collapse" data-target="#add_profit_form" aria-expanded="false" aria-controls="add_profit_form">Add Expense </button>
        <div class="collapse" id="add_profit_form">
            <div class="well">
                <form method="post" action="<?php System::site_url('expenses/add_expense') ?>">
                    <div class="row">
                        <div class="col-md-6">
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <form method="post" action="<?php system::site_url('expenses/change_period'); ?>" class="form-inline show-inline-block">
                    <h3 class="panel-title show-inline-block">Expenses per
                        ...
                        {
                            $dateObj = DateTime::createFromFormat('n', (int)$period_number);
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <?php if (!$expenses): ?>
                        <h4>There is no expenses yet.</h4>
                    <?php else: ?>
            ...
            <div class="panel-footer">
                <ul class="pager">
                    <?php $prev_period = $period_number - 1; if(($period != 'week' && $prev_period > 0) || ($period == 'week' && $prev_period >= $min_week_num)): ?>
                        <li class="previous"><a href="<?php System::site_url('expenses/' . $period . '/' . $prev_period); ?>">Previous</a></li>
                    <?php endif; ?>
                    <?php $next_period = $period_number + 1; if($next_period <= $current_period_number): ?>
                        <li class="next"><a href="<?php $url_part = ($next_period == $current_period_number) ? 'expenses' : 'expenses/' . $period . '/' . $next_period; System::site_url($url_part); ?>">Next</a></li>
                    <?php endif; ?>
                </ul>
            </div>
        </div>
